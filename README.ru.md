...
![Превью мода](docs/images/2025-07-21_04.46.43.png)
...
**Пресс** — обработка металлов и создание пластин под давлением

**Дровяной генератор** — первичный источник энергии на раннем этапе игры

<!-- Скриншот: Мультиблочная структура в работе -->
![Место для скриншота мультиблоков]()
...
![Место для скриншота энергосистемы]()
...
**Радиоактивные материалы** — уран, плутоний, полоний-210 для ядерных технологий
...
**Ура, Радиация!** — достигнуть 200 РАД облучения
