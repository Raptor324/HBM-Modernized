...
/**
 * Direct clone of {@link GUIBarrelSteel} for the tcalloy barrel.
 */
public class GUIBarrelTcalloy extends AbstractContainerScreen<BarrelTcalloyMenu> {
    ...
    private final int tankCapacity = com.hbm_m.blockentity.machines.BarrelTcalloyBlockEntity.CAPACITY;
    ...
    public GUIBarrelTcalloy(BarrelTcalloyMenu menu, Inventory inv, Component title) {
