...
public class GUIMachineLargeTurbine extends GuiInfoScreen<MachineLargeTurbineMenu> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(RefStrings.MODID, "textures/gui/generators/gui_turbine_large.png");

    private final MachineLargeTurbineBlockEntity turbine;

    public GUIMachineLargeTurbine(MachineLargeTurbineMenu menu, Inventory playerInventory, Component title) {
