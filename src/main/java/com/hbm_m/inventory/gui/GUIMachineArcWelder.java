...
public class GUIMachineArcWelder extends GuiInfoScreen<MachineArcWelderMenu> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(RefStrings.MODID, "textures/gui/processing/gui_arc_welder.png");

    private final MachineArcWelderBlockEntity arcWelder;

    public GUIMachineArcWelder(MachineArcWelderMenu menu, Inventory playerInventory, Component title) {
        super(menu, playerInventory, title);
        this.arcWelder = menu.getBlockEntity();
        this.imageWidth = 176;
