...
/** Direct clone of {@link GUIBat9000} for Orbus — same texture/layout, different tank capacity. */
public class GUIOrbus extends AbstractContainerScreen<OrbusMenu> {
    ...
    private final int tankCapacity = com.hbm_m.blockentity.machines.OrbusBlockEntity.CAPACITY;
    ...
    public GUIOrbus(OrbusMenu menu, Inventory inv, Component title) {
