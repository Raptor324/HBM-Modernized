 ...
 * two tank bars, using the previously-unwired {@code gui_industrial_boiler.png} art (a copy of
...
public class GUIMachineIndustrialBoiler extends GuiInfoScreen<MachineIndustrialBoilerMenu> {
    ...
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(RefStrings.MODID, "textures/gui/gui_industrial_boiler.png");

    public GUIMachineIndustrialBoiler(MachineIndustrialBoilerMenu menu, Inventory playerInventory, Component title) {
    ...
    // Tank bars, reverse-engineered from gui_industrial_boiler.png's pixel layout.
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        // Heat gauge decal in the middle of the panel - reuse its footprint for a heat tooltip.
        drawCustomInfoStat(guiGraphics, mouseX, mouseY,
                80, TANK_Y, 51, TANK_HEIGHT,
                mouseX, mouseY,
                Component.translatable("gui.hbm_m.industrial_boiler.heat"),
                Component.literal(menu.getHeat() + " TU"));
