...
/**
 * Direct clone of {@link GUIBarrelSteel} for the antimatter container.
 */
public class GUIBarrelAntimatter extends AbstractContainerScreen<BarrelAntimatterMenu> {
    ...
    private final int tankCapacity = com.hbm_m.blockentity.machines.BarrelAntimatterBlockEntity.CAPACITY;
    ...
    public GUIBarrelAntimatter(BarrelAntimatterMenu menu, Inventory inv, Component title) {
