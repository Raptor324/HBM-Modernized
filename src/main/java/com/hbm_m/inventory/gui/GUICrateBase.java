 ...
 */
public class GUICrateBase<T extends BaseCrateMenu> extends AbstractContainerScreen<T> {

    protected final CrateType crateType;
    protected final ResourceLocation texture;

    public GUICrateBase(T menu, Inventory inventory, Component title, CrateType crateType) {
