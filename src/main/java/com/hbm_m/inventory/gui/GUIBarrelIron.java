 ...
 */
public class GUIBarrelIron extends AbstractContainerScreen<BarrelIronMenu> {
    ...
    private final int tankCapacity = com.hbm_m.blockentity.machines.BarrelIronBlockEntity.CAPACITY;
    ...
    public GUIBarrelIron(BarrelIronMenu menu, Inventory inv, Component title) {
