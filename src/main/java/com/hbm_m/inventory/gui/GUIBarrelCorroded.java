...
import com.hbm_m.inventory.menu.BarrelCorrodedMenu;
...
/**
 * Direct clone of {@link GUIBarrelSteel} for the corroded barrel.
 */
public class GUIBarrelCorroded extends AbstractContainerScreen<BarrelCorrodedMenu> {
    ...
    private final int tankCapacity = com.hbm_m.blockentity.machines.BarrelCorrodedBlockEntity.CAPACITY;
    ...
    public GUIBarrelCorroded(BarrelCorrodedMenu menu, Inventory inv, Component title) {
