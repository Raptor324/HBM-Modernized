...
public class GUIMachineFractionTower extends GuiInfoScreen<MachineFractionTowerMenu> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(RefStrings.MODID, "textures/gui/processing/gui_cracking_tower.png");

    private final MachineFractionTowerBlockEntity tower;

    public GUIMachineFractionTower(MachineFractionTowerMenu menu, Inventory playerInventory, Component title) {
