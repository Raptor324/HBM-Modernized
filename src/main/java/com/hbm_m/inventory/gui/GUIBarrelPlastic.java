...
/**
 * Direct clone of {@link GUIBarrelSteel} for the plastic barrel.
 */
public class GUIBarrelPlastic extends AbstractContainerScreen<BarrelPlasticMenu> {
    ...
    private final int tankCapacity = com.hbm_m.blockentity.machines.BarrelPlasticBlockEntity.CAPACITY;
    ...
    public GUIBarrelPlastic(BarrelPlasticMenu menu, Inventory inv, Component title) {
