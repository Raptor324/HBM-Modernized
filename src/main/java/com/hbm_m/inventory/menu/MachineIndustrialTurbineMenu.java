...
public class MachineIndustrialTurbineMenu extends AbstractContainerMenu {
    ...
    public MachineIndustrialTurbineMenu(int id, Inventory playerInventory, MachineIndustrialTurbineBlockEntity blockEntity, ContainerData data) {
        ...
        this.addSlot(new Slot(machineInventory, SLOT_STEAM_IN, 9, 17));
        this.addSlot(new Slot(machineInventory, SLOT_STEAM_OUT, 9, 53) {
            @Override
        ...
        this.addSlot(new Slot(machineInventory, SLOT_SPENT_IN, 153, 17));
        this.addSlot(new Slot(machineInventory, SLOT_SPENT_OUT, 153, 53) {
            @Override
            public boolean mayPlace(ItemStack stack) {
                return false;
            }
