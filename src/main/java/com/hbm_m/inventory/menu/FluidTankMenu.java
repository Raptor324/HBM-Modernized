...
/**
 * Единое меню для всех вариантов «жидкостной бочки» (tcalloy/plastic/corroded/antimatter/orbus и т.д.) —
 * порт подхода 1.7.10, где все бочки использовали один {@code ContainerBarrel}.
 * {@link MenuType} определяется по блоку block entity через {@link ModMenuTypes#fluidTankMenuType(Block)}.
 */
...
public class FluidTankMenu extends AbstractContainerMenu {
    ...
    public FluidTankMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.fluidTankMenuType(entity.getBlockState().getBlock()), id);
        this.block = entity.getBlockState().getBlock();
        ...
        this.addSlot(new Slot(container, MachineFluidTankBlockEntity.SLOT_ID_IN, 8, 17) {
            @Override
        ...
        this.addSlot(new Slot(container, MachineFluidTankBlockEntity.SLOT_ID_OUT, 8, 53) {
            @Override
            public boolean mayPlace(@NotNull ItemStack stack) {
                return false;
            }
        ...
        this.addSlot(new Slot(container, MachineFluidTankBlockEntity.SLOT_LOAD_IN, 35, 17) {
            @Override
            public boolean mayPlace(@NotNull ItemStack stack) {
        ...
        this.addSlot(new Slot(container, MachineFluidTankBlockEntity.SLOT_LOAD_OUT, 35, 53) {
            @Override
            public boolean mayPlace(@NotNull ItemStack stack) {
                return false;
            }
        ...
        this.addSlot(new Slot(container, MachineFluidTankBlockEntity.SLOT_UNLOAD_IN, 125, 17) {
            @Override
            public boolean mayPlace(@NotNull ItemStack stack) {
                return PlatformHooks.isFluidContainer(stack);
            }
        ...
        this.addSlot(new Slot(container, MachineFluidTankBlockEntity.SLOT_UNLOAD_OUT, 125, 53) {
            @Override
            public boolean mayPlace(@NotNull ItemStack stack) {
                return false;
            }
    ...
    public ItemStack quickMoveStack(Player playerIn, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            if (index < MACHINE_SLOTS) {
                ...
                } else if (PlatformHooks.isFluidContainer(stackInSlot)) {
    ...
    public boolean stillValid(Player player) {
        return MenuReach.stillValid(player, blockEntity, block);
    }
}
