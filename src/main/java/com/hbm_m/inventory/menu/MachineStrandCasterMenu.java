...
public class MachineStrandCasterMenu extends AbstractContainerMenu {
    ...
    private static MachineStrandCasterBlockEntity getBlockEntity(Inventory inventory, FriendlyByteBuf buffer) {
        ...
        throw new MenuBlockEntityMissingException("No MachineStrandCasterBlockEntity found at " + pos);
    }

    @Override
    public boolean stillValid(Player player) {
        return MenuReach.stillValid(player, blockEntity, ModBlocks.STRAND_CASTER.get());
    }
