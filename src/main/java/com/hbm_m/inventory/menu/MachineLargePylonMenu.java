...
public class MachineLargePylonMenu extends AbstractContainerMenu implements ILongEnergyMenu {
    ...
    private final MachineLargePylonBlockEntity blockEntity;
    ...
    public MachineLargePylonMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public MachineLargePylonMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.LARGE_PYLON_MENU.get(), id);
        this.blockEntity = (MachineLargePylonBlockEntity) entity;
    ...
    private static MachineLargePylonBlockEntity getBlockEntity(Inventory inv, FriendlyByteBuf data) {
