...
public class DamageResistanceHandler {
    ...
    public static float calculateDamage(LivingEntity entity, DamageSource damage, float amount, float pierceDT, float pierceDR) {
        ...
        dr *= Math.max(0F, Math.min(2F, 1F - pierceDR)); // Allow up to -1 pierce (double effective armor)
    ...
    /**
     * Register individual armor piece
     */
    ...
    public static void initArmorStats() {
        ...
        // RPA Power Armor (from original)
        // TODO: Add RPA armor when implemented
    }
}