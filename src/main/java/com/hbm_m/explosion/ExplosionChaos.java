...
public final class ExplosionChaos {
     ...
     * Тело — построчная копия конструктора {@code EntityBulletBaseMK4}. Оригинальные вызывающие
     * (EntityMissileCluster) передают rotationYaw/rotationPitch в градусах, а разброс в радианах,
     * из-за чего две конверсии внутри взаимно уничтожаются. Поведение сохранено как в оригинале.
     */
