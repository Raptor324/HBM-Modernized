...
public class GrenadeheProjectileEntity extends ThrowableItemProjectile {
    ...
    protected void onHitBlock(BlockHitResult pResult) {
        ...
        // Если в родительском классе (ThrowableItemProjectile) есть какая-либо важная логика
        // при попадании в блок, которую ты хочешь сохранить, раскомментируй следующую строку.
        // Однако, если граната должна просто исчезнуть после взрыва, это обычно не требуется.
