...
public class TownauraParticle extends TextureSheetParticle {
    ...
    protected TownauraParticle(ClientLevel level, double x, double y, double z,
        ...
        float color = 0.5F + this.random.nextFloat() * 0.5F;
        this.rCol = 0.8F * color;
        this.gCol = 0.9F * color;
        this.bCol = 1.0F * color;
        ...
        if (vy > 0.0D) {
            // Decon: mY = 0.04, ~2.5 блока вверх при DRAG (как EntityModFX + setVelocity в 1.7.10).
            this.lifetime = 100 + this.random.nextInt(21);
        } else {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType particleType, @NotNull ClientLevel level,
            ...
            return new TownauraParticle(level, x, y, z, dx, dy, dz, this.spriteSet);
        }
    }
}
