...
public class ShredderMenu extends AbstractContainerMenu {
    public final ShredderBlockEntity blockEntity;
    ...
    public ShredderMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.SHREDDER_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        blockEntity = ((ShredderBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.SHREDDER.get());
    }
