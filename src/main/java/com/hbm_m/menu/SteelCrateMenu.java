...
public class SteelCrateMenu extends BaseCrateMenu {
    ...
    public SteelCrateMenu(int containerId, Inventory inv, BlockEntity entity) {
        super(ModMenuTypes.STEEL_CRATE_MENU.get(), containerId, inv,
                entity instanceof SteelCrateBlockEntity be ? be
                        : new SteelCrateBlockEntity(BlockPos.ZERO, ModBlocks.CRATE_STEEL.get().defaultBlockState()),
                CrateType.STEEL);
    }

    @Override
    protected Block getBlock() {
        return ModBlocks.CRATE_STEEL.get();
    }
}
