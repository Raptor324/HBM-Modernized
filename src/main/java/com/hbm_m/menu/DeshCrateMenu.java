...
public class DeshCrateMenu extends BaseCrateMenu {
    ...
    public DeshCrateMenu(int containerId, Inventory inv, BlockEntity entity) {
        super(ModMenuTypes.DESH_CRATE_MENU.get(), containerId, inv,
                entity instanceof DeshCrateBlockEntity be ? be
    ...
    protected Block getBlock() {
        return ModBlocks.CRATE_DESH.get();
    }
}
