...
public class MachineSilexBlockEntity extends BaseMachineBlockEntity {
    ...
    public MachineSilexBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.SILEX_BE.get(), pos, state, 0, 0L, 0L, 0L);
    }

    public static void tick(Level level, BlockPos pos, BlockState state, MachineSilexBlockEntity blockEntity) {
