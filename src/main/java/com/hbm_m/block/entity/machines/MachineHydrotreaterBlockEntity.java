...
public class MachineHydrotreaterBlockEntity extends BaseMachineBlockEntity {
    public MachineHydrotreaterBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.HYDROTREATER_BE.get(), pos, state, 6, 500_000L, 10_000L);
    }
    ...
    @Override public Component getDisplayName() { return Component.translatable("container.hbm_m.hydrotreater"); }
    @Nullable @Override public AbstractContainerMenu createMenu(int id, Inventory inv, Player player) { return null; }
    @Override protected Component getDefaultName() { return Component.translatable("container.hbm_m.hydrotreater"); }
