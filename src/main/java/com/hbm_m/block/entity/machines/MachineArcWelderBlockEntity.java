...
public class MachineArcWelderBlockEntity extends BaseMachineBlockEntity {
    ...
    public MachineArcWelderBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.ARC_WELDER_BE.get(), pos, state, 0, 0L, 0L);
    }

    public static void tick(Level level, BlockPos pos, BlockState state, MachineArcWelderBlockEntity blockEntity) {
    ...
    protected Component getDefaultName() {
        return Component.translatable("block.hbm_m.arc_welder");
    }
    ...
    public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
        return MachineArcWelderMenu.create(id, inventory, this);
    }
}
