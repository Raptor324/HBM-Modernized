...
public class MachineWatzPowerplantBlockEntity extends BaseMachineBlockEntity {
    ...
    public MachineWatzPowerplantBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.WATZ_POWERPLANT_BE.get(), pos, state, 6, 10_000_000L, 50_000L);
    }
    ...
    @Override public Component getDisplayName() { return Component.translatable("container.hbm_m.watz_powerplant"); }
