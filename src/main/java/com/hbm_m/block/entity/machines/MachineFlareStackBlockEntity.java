...
public class MachineFlareStackBlockEntity extends BaseMachineBlockEntity {
    ...
    public MachineFlareStackBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.FLARE_STACK_BE.get(), pos, state, 0, 0L, 0L, 0L);
    }

    public static void tick(Level level, BlockPos pos, BlockState state, MachineFlareStackBlockEntity blockEntity) {
