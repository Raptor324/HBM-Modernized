...
public class MachineTurbineBlockEntity extends BaseMachineBlockEntity {
    ...
    private static class SteamInputHandler implements IFluidHandler {
        ...
        SteamInputHandler(MachineTurbineBlockEntity be) {
            this.be = be;
        }
        ...
        @Override
        public int getTankCapacity(int tank) { return be.tanks[0].getMaxFill(); }
    ...
    private static class SpentOutputHandler implements IFluidHandler {
        ...
        SpentOutputHandler(MachineTurbineBlockEntity be) {
            this.be = be;
        }
        ...
        @Override
        public int getTankCapacity(int tank) { return be.tanks[1].getMaxFill(); }
