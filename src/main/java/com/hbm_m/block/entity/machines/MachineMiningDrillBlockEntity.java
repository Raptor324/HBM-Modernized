...
public class MachineMiningDrillBlockEntity extends BaseMachineBlockEntity {
    ...
    public MachineMiningDrillBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.MINING_DRILL_BE.get(), pos, state, 0, 0L, 0L, 0L);
    }

    public static void tick(Level level, BlockPos pos, BlockState state, MachineMiningDrillBlockEntity blockEntity) {
