...
public class MachineChemicalFactoryBlockEntity extends BaseMachineBlockEntity {
    public MachineChemicalFactoryBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CHEMICAL_FACTORY_BE.get(), pos, state, 10, 1_000_000L, 20_000L);
    }
    ...
    @Override public Component getDisplayName() { return Component.translatable("container.hbm_m.chemical_factory"); }
    @Nullable @Override public AbstractContainerMenu createMenu(int id, Inventory inv, Player player) { return null; }
    @Override protected Component getDefaultName() { return Component.translatable("container.hbm_m.chemical_factory"); }
