...
public final class AssemblerRecipeGenerator {
    ...
    private static void registerTurrets(Consumer<FinishedRecipe> writer) {
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.TURRET_TAUON.get()), 240, 150)
                .addIngredient(ModMaterialItems.item(ModMaterials.TITANIUM, MaterialShape.PLATE), 4)
                .addIngredient(ModItems.MOTOR.get(), 1)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.TURRET_HOWARD.get()), 280, 200)
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.PLATE), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.TURRET_ARTY.get()), 400, 300)
                .addIngredient(ModMaterialItems.item(ModMaterials.DESH, MaterialShape.PLATE), 6)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.TURRET_HIMARS.get()), 480, 350)
                .addIngredient(ModMaterialItems.item(ModMaterials.DESH, MaterialShape.PLATE), 8)
    ...
    private static void registerGapMachines(Consumer<FinishedRecipe> writer) {
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.ARC_FURNACE.get(), 1), 200, 100)
                ...
                .addIngredient(Ingredient.of(
                        ...
                        ModMaterialItems.item(ModMaterials.BAKELITE, MaterialShape.INGOT)), 8)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.HYDROTREATER.get(), 1), 200, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE_WELDED), 8)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE_CAST), 4)
                .addIngredient(ModMaterialItems.item(ModMaterials.NIOBIUM, MaterialShape.INGOT), 8)
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.INGOT), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.FURNACE_IRON.get(), 1), 100, 60)
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 24)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.FURNACE_STEEL.get(), 1), 150, 80)
                ...
                .addIngredient(ModItems.FIREBRICK.get(), 16)
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 16)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.ROTARY_FURNACE.get(), 1), 200, 120)
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE_CAST), 8)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.MICROWAVE.get(), 1), 120, 60)
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 12)
                .addIngredient(ModMaterialItems.item(ModMaterials.RED_COPPER, MaterialShape.INGOT), 4)
                .addIngredient(Ingredient.of(Items.REDSTONE), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.RADIOLYSIS.get(), 1), 150, 80)
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.INGOT), 8)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.ELECTROLYSER.get(), 1), 200, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.LEAD, MaterialShape.PLATE), 16)
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.INGOT), 10)
                .addIngredient(ModItems.PIPE_STEEL.get(), 8)
                .addIngredient(ModItems.CIRCUIT_STAR.get(), 2)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.SAWMILL.get(), 1), 100, 60)
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 12)
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.INGOT), 4)
                .save(writer, "sawmill");
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.AUTOSAW.get(), 1), 150, 80)
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 16)
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.INGOT), 8)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.AMMO_PRESS.get(), 1), 150, 90)
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.INGOT), 20)
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 12)
                .addIngredient(ModItems.PISTON_SET_STEEL.get(), 1)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.LIQUEFACTOR.get(), 1), 200, 100)
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE), 12)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.CATALYTIC_REFORMER.get(), 1), 200, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE_CAST), 12)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE), 8)
                .addIngredient(ModMaterialItems.item(ModMaterials.NIOBIUM, MaterialShape.INGOT), 8)
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.INGOT), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.VACUUM_DISTILL.get(), 1), 200, 100)
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE), 16)
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.INGOT), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.TURBOFAN.get(), 1), 300, 100)
                ...
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.POLYMER, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.BAKELITE, MaterialShape.INGOT)), 12)
                .addIngredient(ModItems.TURBINE_TUNGSTEN.get(), 1)
                .addIngredient(ModMaterialItems.item(ModMaterials.GOLD, MaterialShape.WIRE_DENSE), 12)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.COMBINATION_OVEN.get(), 1), 200, 100)
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE_CAST), 2)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModBlocks.FRACTION_TOWER.get(), 1), 200, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE_WELDED), 6)
    ...
    private static void registerMachineParts(Consumer<FinishedRecipe> writer) {
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.SATURNITE, MaterialShape.PLATE), 1)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.ASBESTOS, MaterialShape.INGOT), 1)
                .addIngredient(Items.STRING, 8)
                .save(writer, "firecloth");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.FILTER_COAL.get(), 1), 50, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.COAL, MaterialShape.POWDER), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.DURA_STEEL, MaterialShape.PLATE_CAST), 1)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.DURA_STEEL, MaterialShape.PLATE_CAST), 4)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE), 24)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.LITHIUM, MaterialShape.POWDER), 1)
                .save(writer, "partlith");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.PART_BERYLLIUM.get(), 8), 40, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.BERYLLIUM, MaterialShape.POWDER), 1)
                .save(writer, "partberyl");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.PART_CARBON.get(), 8), 40, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.COAL, MaterialShape.POWDER), 1)
                .save(writer, "partcoal");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.PART_PLUTONIUM.get(), 8), 40, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.PLUTONIUM, MaterialShape.POWDER), 1)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.COMBINE_STEEL, MaterialShape.PLATE), 4)
                .save(writer, "cmbtile");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModBlocks.CMB_BRICK_REINFORCED.get(), 8), 100, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.MAGNETIZED_TUNGSTEN, MaterialShape.INGOT), 8)
    ...
    private static void registerMachines(Consumer<FinishedRecipe> writer) {
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.DESH, MaterialShape.INGOT), 12)
                .addIngredient(ModMaterialItems.item(ModMaterials.NIOBIUM, MaterialShape.INGOT), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE_CAST), 8)
                .addIngredient(ModMaterialItems.item(ModMaterials.DESH, MaterialShape.INGOT), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.INGOT), 12)
                .addIngredient(ModMaterialItems.item(ModMaterials.TUNGSTEN, MaterialShape.INGOT), 4)
                .save(writer, "drillsteel");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.DRILLBIT_HSS.get(), 1), 100, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.DURA_STEEL, MaterialShape.INGOT), 12)
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.POLYMER, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.BAKELITE, MaterialShape.INGOT)), 12)
                .addIngredient(ModMaterialItems.item(ModMaterials.TITANIUM, MaterialShape.INGOT), 8)
                .save(writer, "drilldura");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.DRILLBIT_DESH.get(), 1), 100, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.DESH, MaterialShape.INGOT), 16)
                .addIngredient(ModMaterialItems.item(ModMaterials.RUBBER, MaterialShape.INGOT), 12)
                .addIngredient(ModMaterialItems.item(ModMaterials.NIOBIUM, MaterialShape.INGOT), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.DURA_STEEL, MaterialShape.PLATE), 4)
                .addIngredient(ModMaterialItems.item(ModMaterials.REDSTONE, MaterialShape.CRYSTAL), 3)
    ...
    private static void registerGenerators(Consumer<FinishedRecipe> writer) {
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.DESH, MaterialShape.INGOT), 24)
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.POLYMER, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.BAKELITE, MaterialShape.INGOT)), 12)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE), 24)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STARMETAL, MaterialShape.INGOT), 24)
                .addIngredient(ModMaterialItems.item(ModMaterials.RUBBER, MaterialShape.INGOT), 16)
                .addIngredient(ModMaterialItems.item(ModMaterials.SATURNITE, MaterialShape.PLATE), 24)
                .addIngredient(ModMaterialItems.item(ModMaterials.NIOBIUM, MaterialShape.INGOT), 16)
                .addIngredient(ModItems.PIPE_DURA_STEEL.get(), 4)
    ...
    private static void registerAccelerators(Consumer<FinishedRecipe> writer) {
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE_CAST), 8)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE), 16)
                .addIngredient(ModMaterialItems.item(ModMaterials.GOLD, MaterialShape.WIRE_DENSE), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE_CAST), 16)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE), 64)
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.PVC, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.POLYMER_COMPOSITE, MaterialShape.INGOT)), 16)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.PVC, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.POLYMER_COMPOSITE, MaterialShape.INGOT)), 32)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.ALUMINIUM, MaterialShape.PLATE_CAST), 12)
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.INGOT), 4)
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.PVC, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.POLYMER_COMPOSITE, MaterialShape.INGOT)), 12)
                .addIngredient(ModMaterialItems.item(ModMaterials.GOLD, MaterialShape.WIRE_DENSE), 32)
                .addIngredient(ModItems.MOTOR_DESH.get(), 2)
                .addIngredient(ModItems.BISMOID_CIRCUIT.get(), 4)
                .addIngredient(ModItems.CAPACITOR_TANTALUM.get(), 1)
                .addIngredient(ModBlocks.GLASS_QUARTZ.get().asItem(), 16)
    ...
    private static void registerReactors(Consumer<FinishedRecipe> writer) {
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE_CAST), 2)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE_CAST), 2)
                .addIngredient(ModMaterialItems.item(ModMaterials.BORON, MaterialShape.INGOT), 4)
                .addIngredient(ModItems.MOTOR.get(), 1)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.LEAD, MaterialShape.PLATE), 4)
                .addIngredient(Ingredient.of(ModBlocks.CONCRETE.get().asItem()), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.ZIRCONIUM, MaterialShape.PLATE_WELDED), 1)
                .addIngredient(ModMaterialItems.item(ModMaterials.RA226BE, MaterialShape.BILLET), 3)
    ...
    private static void registerFusionReactor(Consumer<FinishedRecipe> writer) {
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.PVC, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.POLYMER_COMPOSITE, MaterialShape.INGOT)), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.ALLOY, MaterialShape.PLATE_CAST), 4)
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 16)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.ALLOY, MaterialShape.PLATE_CAST), 16)
    ...
    private static void registerUpgrades(Consumer<FinishedRecipe> writer) {
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE_CAST), 2)
                .addIngredient(ModMaterialItems.item(ModMaterials.ZIRCONIUM, MaterialShape.INGOT), 2)
                .addIngredient(ModMaterialItems.item(ModMaterials.SATURNITE, MaterialShape.INGOT), 2)
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.PVC, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.POLYMER_COMPOSITE, MaterialShape.INGOT)), 4)
                .save(writer, "watzrod");
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.SATURNITE, MaterialShape.INGOT), 16)
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.PVC, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.POLYMER_COMPOSITE, MaterialShape.INGOT)), 16)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModItems.UPGRADE_EFFECT_3.get(), 1)
                .addIngredient(ModMaterialItems.item(ModMaterials.SATURNITE, MaterialShape.INGOT), 16)
                .addIngredient(ModMaterialItems.item(ModMaterials.CFT, MaterialShape.INGOT), 8)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.CFT, MaterialShape.INGOT), 16)
    ...
    private static void registerBombParts(Consumer<FinishedRecipe> writer) {
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.PLUTONIUM239, MaterialShape.NUGGET), 7)
                .addIngredient(ModMaterialItems.item(ModMaterials.URANIUM238, MaterialShape.NUGGET), 3)
                .save(writer, "core1");
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.URANIUM235, MaterialShape.NUGGET), 18)
                .save(writer, "boytarget");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.BOY_BULLET.get(), 1), 200, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.URANIUM235, MaterialShape.NUGGET), 9)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.FAT_MAN_CORE.get(), 1), 1200, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.PLUTONIUM239, MaterialShape.NUGGET), 8)
                .addIngredient(ModMaterialItems.item(ModMaterials.BERYLLIUM, MaterialShape.NUGGET), 2)
                .save(writer, "mancore");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.MIKE_CORE.get(), 1), 1200, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.URANIUM238, MaterialShape.NUGGET), 24)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.GUNSTEEL, MaterialShape.PLATE), 16)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.URANIUM235, MaterialShape.NUGGET), 8)
                .addIngredient(ModMaterialItems.item(ModMaterials.NEPTUNIUM, MaterialShape.NUGGET), 2)
                .addIngredient(ModMaterialItems.item(ModMaterials.BERYLLIUM, MaterialShape.NUGGET), 4)
                .addIngredient(ModItems.COIL_COPPER.get(), 2)
                .save(writer, "fleijacore");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.SOLINIUM_CORE.get(), 1), 600, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.SOLINIUM, MaterialShape.NUGGET), 9)
                .addIngredient(ModMaterialItems.item(ModMaterials.EUPHEMIUM, MaterialShape.NUGGET), 1)
    ...
    private static void registerMissileParts(Consumer<FinishedRecipe> writer) {
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.DURA_STEEL, MaterialShape.INGOT), 32)
                .addIngredient(ModMaterialItems.item(ModMaterials.BORON, MaterialShape.INGOT), 8)
                .addIngredient(ModMaterialItems.item(ModMaterials.LEAD, MaterialShape.PLATE), 16)
                .addIngredient(ModItems.PIPE_STEEL.get(), 4)
    ...
    private static void registerAmmo(Consumer<FinishedRecipe> writer) {
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.POLYMER, MaterialShape.INGOT), 1)
    ...
    private static void registerSpace(Consumer<FinishedRecipe> writer) {
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE_WELDED), 16)
                .addIngredient(ModItems.UPGRADE_SPEED_3.get(), 1)
    ...
    private static void registerMainRecipes(Consumer<FinishedRecipe> writer) {
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.POLYMER, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.BAKELITE, MaterialShape.INGOT)), 4)
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 8)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE), 4)
                .addIngredient(ModItems.ANALOG_CIRCUIT.get(), 1)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE_WELDED), 3)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE), 8)
                .addIngredient(ModItems.SHELL_STEEL.get(), 4)
                .addIngredient(ModItems.PIPE_STEEL.get(), 12)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 8)
                .addIngredient(ModMaterialItems.item(ModMaterials.BIORUBBER, MaterialShape.INGOT), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 16)
                .addIngredient(ModMaterialItems.item(ModMaterials.RUBBER, MaterialShape.INGOT), 6)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 12)
                .addIngredient(ModItems.PIPE_STEEL.get(), 6)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.WIRE_DENSE), 6)
                .addIngredient(ModItems.INTEGRATED_CIRCUIT.get(), 1)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 10)
                .addIngredient(ModItems.PIPE_STEEL.get(), 4)
                .addIngredient(ModItems.MOTOR.get(), 1)
                .addIngredient(ModItems.INTEGRATED_CIRCUIT.get(), 1)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE_WELDED), 6)
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.CADMIUM, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.TECHNETIUM, MaterialShape.INGOT)), 4)
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.RUBBER, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.BIORUBBER, MaterialShape.INGOT)), 24)
                .addIngredient(ModItems.MAGNETRON.get(), 16)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModItems.DRILL_TITANIUM.get(), 1)
                .addIngredient(ModItems.MOTOR_DESH.get(), 2)
                .addIngredient(ModMaterialItems.item(ModMaterials.DESH, MaterialShape.PLATE), 24)
    ...
    private static void registerDoorRecipes(Consumer<FinishedRecipe> writer) {
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 4) //Welded Plate needs added.
                .addIngredient(ModItems.INSULATOR.get(), 4)
                .addIngredient(ModItems.MOTOR.get(), 2)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 6) //Welded Plate needs added.
                .addIngredient(ModItems.INSULATOR.get(), 8)
                .addIngredient(ModItems.MOTOR.get(), 2)
                .addIngredient(ModItems.BOLT_STEEL.get(), 16)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 4) //CAST STEEL PLATE NEEDED
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.PLATE), 4)
                .addIngredient(ModItems.INSULATOR.get(), 8)
                .addIngredient(ModItems.MOTOR.get(), 2)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 12) //CAST STEEL PLATE NEEDED
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.PLATE), 8)
                .addIngredient(ModItems.INSULATOR.get(), 16)
                .addIngredient(ModItems.MOTOR.get(), 4)
                .addIngredient(ModItems.BOLT_HIGHSPEED_STEEL.get(), 16)
                .addIngredient(Ingredient.of(Tags.Items.DYES_GREEN), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 12) //CAST STEEL PLATE NEEDED
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.PLATE), 16)
                .addIngredient(ModItems.INSULATOR.get(), 8)
                .addIngredient(ModItems.MOTOR.get(), 4)
                .addIngredient(ModItems.BOLT_HIGHSPEED_STEEL.get(), 32)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.INGOT), 32)
                .addIngredient(ModMaterialItems.item(ModMaterials.DURA_STEEL, MaterialShape.INGOT), 32)
                .addIngredient(ModMaterialItems.item(ModMaterials.LEAD, MaterialShape.PLATE), 8) //PLATE_CAST_LEAD NEEDED
                .addIngredient(ModItems.MOTOR.get(), 3)
                .addIngredient(ModItems.BOLT_HIGHSPEED_STEEL.get(), 32)
                .addIngredient(ModMaterialItems.item(ModMaterials.RUBBER, MaterialShape.INGOT), 12)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 30)
                .addIngredient(ModItems.INSULATOR.get(), 4)
    ...
    private static void registerElectronics(Consumer<FinishedRecipe> writer) {
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.CARBON, MaterialShape.WIRE), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.CARBON, MaterialShape.WIRE), 3)
                .addIngredient(ModItems.PCB.get(), 1)
                .save(writer, "capacitor_board");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.ADVANCED_CIRCUIT.get(), 1), 120, 250)
                .addIngredient(ModMaterialItems.item(ModMaterials.CARBON, MaterialShape.WIRE), 8)
    ...
    private static void registerBombRecipes(Consumer<FinishedRecipe> writer) {
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.ALUMINUM, MaterialShape.PLATE), 8)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(  //TODO: WIP RECIPES, NEEDS REWORK WHEN FULL PROCESSING IS PORTED
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.PLATE), 16)
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 40)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.WIRE), 10)
                .addIngredient(ModMaterialItems.item(ModMaterials.LEAD, MaterialShape.POWDER), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.FAT_MAN_EXPLOSIVE.get(), 1), 300, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.ALUMINUM, MaterialShape.PLATE), 6)
                .addIngredient(ModItems.BALL_TNT.get(), 4)
                .addIngredient(Ingredient.of(
                        ModMaterialItems.item(ModMaterials.POLYMER, MaterialShape.INGOT),
                        ModMaterialItems.item(ModMaterials.BAKELITE, MaterialShape.INGOT)), 2)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.PLATE), 2)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 24)
                .addIngredient(ModMaterialItems.item(ModMaterials.ALUMINUM, MaterialShape.PLATE), 12)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.WIRE), 16)
                .addIngredient(ModItems.GADGET_WIREING.get(), 1)
                .addIngredient(ModItems.GADGET_CORE.get(), 1)
                .addIngredient(ModItems.FAT_MAN_EXPLOSIVE.get(), 1)
                .save(writer, "nuke_gadget");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModBlocks.NUKE_BOY.get(), 1), 120, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 24)
                .addIngredient(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.WIRE), 12)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.PLATE), 16)
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 48)
                .addIngredient(ModItems.EXPLOSIVE_LENSES.get(), 1)
                .addIngredient(ModItems.FAT_MAN_CORE.get(), 1)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.PLATE), 32)
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 64)
                .addIngredient(ModItems.EXPLOSIVE_LENSES.get(), 1)
                .addIngredient(ModItems.FAT_MAN_CORE.get(), 1)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.PLATE), 20)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 32)
    ...
    private static void registerCastPlateRecipes(Consumer<FinishedRecipe> writer) {
        ...
        AssemblerRecipeBuilder.assemblerRecipe(new ItemStack(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE_CAST), 1), 60, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 2)
    ...
    private static void registerPlateRecipes(Consumer<FinishedRecipe> writer) {
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.IRON, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(Items.IRON_INGOT, 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_iron_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.GOLD, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(Items.GOLD_INGOT, 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_gold_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_steel_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.SATURNITE, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.SATURNITE, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_saturnite_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.SCHRABIDIUM, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.SCHRABIDIUM, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_schrabidium_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.TITANIUM, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.TITANIUM, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_titanium_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.GUNMETAL, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.GUNMETAL, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_gunmetal_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.GUNSTEEL, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.GUNSTEEL, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_gunsteel_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.LEAD, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.LEAD, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_lead_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.COPPER, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(Items.COPPER_INGOT, 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_copper_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.ADVANCED_ALLOY, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_advanced_alloy_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.ALUMINUM, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.ALUMINUM, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_aluminum_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.BISMUTH, MaterialShape.PLATE), 2), 60, 100)
                .addIngredient(ModMaterialItems.item(ModMaterials.BISMUTH, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_bismuth_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                    new ItemStack(ModMaterialItems.item(ModMaterials.COMBINE_STEEL, MaterialShape.PLATE), 2), 80, 150)
                .addIngredient(ModMaterialItems.item(ModMaterials.COMBINE_STEEL, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_combine_steel_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.DURA_STEEL, MaterialShape.PLATE), 2), 80, 150)
                .addIngredient(ModMaterialItems.item(ModMaterials.DURA_STEEL, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_dura_steel_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModItems.PLATE_DALEKANIUM.get(), 2), 100, 200)
                .addIngredient(ModMaterialItems.item(ModMaterials.DIGAMMA, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_dalekanium_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.DESH, MaterialShape.PLATE), 2), 100, 200)
                .addIngredient(ModMaterialItems.item(ModMaterials.DESH, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
                .save(writer, "plate_desh_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.DINEUTRONIUM, MaterialShape.PLATE), 1), 200, 500)
                .addIngredient(ModMaterialItems.item(ModMaterials.DINEUTRONIUM, MaterialShape.INGOT), 2)
                .withBlueprintPool("plates")
                .save(writer, "plate_dineutronium_from_ingots");

        AssemblerRecipeBuilder.assemblerRecipe(
                        new ItemStack(ModMaterialItems.item(ModMaterials.EUPHEMIUM, MaterialShape.PLATE), 2), 120, 250)
                .addIngredient(ModMaterialItems.item(ModMaterials.EUPHEMIUM, MaterialShape.INGOT), 3)
                .withBlueprintPool("plates")
    ...
    private static void registerMissileRecipes(Consumer<FinishedRecipe> writer) { // TODO: WIP RECIPES, NEEDS REWORK WHEN FULL PROCESSING IS PORTED
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.TITANIUM, MaterialShape.PLATE), 6)
                .addIngredient(ModMaterialItems.item(ModMaterials.STEEL, MaterialShape.PLATE), 4)
        ...
        AssemblerRecipeBuilder.assemblerRecipe(
                ...
                .addIngredient(ModMaterialItems.item(ModMaterials.PLUTONIUM, MaterialShape.BILLET), 4)
                .addIngredient(ModMaterialItems.item(ModMaterials.SCHRABIDIUM, MaterialShape.PLATE), 4)
                .addIngredient(ModItems.BALL_TNT.get(), 8)
                .addIngredient(ModItems.ADVANCED_CIRCUIT.get(), 2)
