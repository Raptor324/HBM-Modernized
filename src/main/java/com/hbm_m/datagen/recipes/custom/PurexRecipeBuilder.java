...
public class PurexRecipeBuilder implements RecipeBuilder {
    ...
    private PurexRecipeBuilder(int duration, int power) {
        this.duration = duration;
        this.power = power;
    }

    public static PurexRecipeBuilder purexRecipe(int duration, int power) {
        return new PurexRecipeBuilder(duration, power);
    }

    public PurexRecipeBuilder addItemInput(Ingredient ingredient, int count) {
        this.itemInputs.add(new CountedIngredient(ingredient, count));
        return this;
    }

    public PurexRecipeBuilder addItemInput(Item item, int count) {
        return addItemInput(Ingredient.of(item), count);
    }

    public PurexRecipeBuilder addFluidInput(Fluid fluid, int amountMb) {
    ...
    public PurexRecipeBuilder addFluidOutput(Fluid fluid, int amountMb) {
        this.fluidOutputs.add(new FluidAmount(fluid, amountMb));
        return this;
    }

    public PurexRecipeBuilder withIconItem(ItemStack stack) {
        this.iconItem = (stack == null || stack.isEmpty()) ? null : stack.copy();
        return this;
    }

    public PurexRecipeBuilder withIconItem(Item item) {
        return withIconItem(new ItemStack(item));
    }

    public PurexRecipeBuilder withIconFluid(Fluid fluid) {
        this.iconFluid = fluid;
        return this;
    }

    public PurexRecipeBuilder withBlueprintPool(String pool) {
    ...
    private static final class Result implements FinishedRecipe {
        ...
        private final PurexRecipeBuilder builder;

        private Result(ResourceLocation id, PurexRecipeBuilder builder) {
            this.id = id;
        ...
        public RecipeSerializer<?> getType() {
            return PurexRecipe.Serializer.INSTANCE;
        }
