 ...
 *
 * <p>Vanilla's {@link RecordItem#appendHoverText} adds exactly one line - the {@code .desc}
 ...
 * Stonecutter branch inside the body, whereas {@link RecordItem#getDisplayName()} is identical on
 * both.</p>
 */
